...
Course Module 3: Java Collections
...
Collection, Iterable, Iterator, List, ArrayList, LinkedList, Set, Map, Queue, Deque, PriorityQueue, enhanced for, iterator remove, ListIterator, Collections, Arrays.

## Java Files in This Folder

- `PracticeModule03Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule03Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule03Demo.java` to frame the topic and vocabulary.
