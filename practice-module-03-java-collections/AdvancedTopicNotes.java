...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "Collection, Iterable, Iterator, List, ArrayList, LinkedList, Set, Map, Queue, Deque, PriorityQueue, enhanced for, iterator remove, ListIterator, Collections, Arrays";
}
