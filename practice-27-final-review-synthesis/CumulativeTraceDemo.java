...
public class CumulativeTraceDemo {
    public static void run() {
        System.out.println("-- CumulativeTraceDemo: complexity classification, selection, tracing, trees, heaps, hashing, sorting, graphs, shortest paths, MST, final prompts");
        int[] data = {7, 3, 9, 1, 5};
