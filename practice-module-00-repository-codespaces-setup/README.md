...
Course Module 0: Repository and Codespaces Setup

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 1.1.

## Theory Topics Covered

Java compilation, terminal workflow, basic class structure, command-line execution, simple output.

## Java Files in This Folder

- `PracticeModule00Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule00Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule00Demo.java` to frame the topic and vocabulary.
