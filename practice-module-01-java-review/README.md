...
Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 1.2-1.5.

## Theory Topics Covered

variables, primitive types, references, arrays, loops, nested loops, methods, classes, objects, generics, Comparable, Comparator, timing, common mistakes.

## Java Files in This Folder

- `PracticeModule01Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule01Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule01Demo.java` to frame the topic and vocabulary.
