...
Course Module 14: B-Trees and Multi-Way Search
...
B-tree search and insertion, node capacity, multi-way search, split, median promotion, root split, leaf split, internal split, trace, disk/block motivation, deletion concepts.

## Java Files in This Folder

- `PracticeModule14Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule14Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule14Demo.java` to frame the topic and vocabulary.
