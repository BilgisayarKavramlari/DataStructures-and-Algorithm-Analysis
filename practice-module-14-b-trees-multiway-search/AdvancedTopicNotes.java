...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "B-tree search and insertion, node capacity, multi-way search, split, median promotion, root split, leaf split, internal split, trace, disk/block motivation, deletion concepts";
}
