...
/** Educational demo for Binary Heap and Priority Queue. */
public class BuildHeapExperiment {
    public static void main(String[] args) {
        int[] data = {5, 2, 8, 1, 3};
        System.out.println("BuildHeapExperiment: Binary Heap and Priority Queue");
