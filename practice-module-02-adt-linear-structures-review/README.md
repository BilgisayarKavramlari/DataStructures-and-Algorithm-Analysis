...
Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 3.

## Theory Topics Covered

ADT idea, List ADT, array list, linked list, doubly linked list, stack, queue, deque, iterator, structural modification, ConcurrentModificationException.

## Java Files in This Folder

- `PracticeModule02Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule02Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule02Demo.java` to frame the topic and vocabulary.
