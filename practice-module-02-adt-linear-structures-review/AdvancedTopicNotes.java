...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "ADT idea, List ADT, array list, linked list, doubly linked list, stack, queue, deque, iterator, structural modification, ConcurrentModificationException";
}
