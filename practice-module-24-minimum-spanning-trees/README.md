...
Course Module 24: Minimum Spanning Trees
...
Prim, Kruskal, MST trace, union-find, priority queue, MST vs shortest path, disconnected graph handling, weighted test cases.

## Java Files in This Folder

- `PracticeModule24Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule24Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule24Demo.java` to frame the topic and vocabulary.
