...
public class PairingHeapEducationalDemo {
    public static void run() {
        System.out.println("-- PairingHeapEducationalDemo: data structure choice, operation tradeoffs, real-world cases, treap, suffix-array-style index, k-d tree, pairing heap, complexity summary");
        int[] data = {7, 3, 9, 1, 5};
