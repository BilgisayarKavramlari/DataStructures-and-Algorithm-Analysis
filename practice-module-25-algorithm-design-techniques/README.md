...
Course Module 25: Algorithm Design Techniques

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 10,12.

## Theory Topics Covered

greedy scheduling, Huffman coding, approximate bin packing, divide and conquer, closest-pair simplified, selection, dynamic programming, matrix chain, optimal BST simplified, randomized quicksort, skip list, primality testing, backtracking.

## Java Files in This Folder

- `PracticeModule25Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule25Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule25Demo.java` to frame the topic and vocabulary.
