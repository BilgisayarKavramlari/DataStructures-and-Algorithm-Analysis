...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "greedy scheduling, Huffman coding, approximate bin packing, divide and conquer, closest-pair simplified, selection, dynamic programming, matrix chain, optimal BST simplified, randomized quicksort, skip list, primality testing, backtracking";
}
