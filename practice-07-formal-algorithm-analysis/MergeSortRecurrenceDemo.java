...
public class MergeSortRecurrenceDemo {
    public static void run() {
        System.out.println("-- MergeSortRecurrenceDemo: Big-O, Big-Omega, Big-Theta, little-o, little-omega, loop rules, binary search, recurrences, space complexity");
        int[] data = {7, 3, 9, 1, 5};
