...
public class IfElseAnalysisDemo {
    public static void run() {
        System.out.println("-- IfElseAnalysisDemo: Big-O, Big-Omega, Big-Theta, little-o, little-omega, loop rules, binary search, recurrences, space complexity");
        int[] data = {7, 3, 9, 1, 5};
