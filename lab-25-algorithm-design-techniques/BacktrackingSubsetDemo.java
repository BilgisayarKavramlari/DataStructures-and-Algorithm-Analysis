...
/** Educational demo for Algorithm Design Techniques. */
public class BacktrackingSubsetDemo {
    public static void main(String[] args) {
        int[] data = {5, 2, 8, 1, 3};
        System.out.println("BacktrackingSubsetDemo: Algorithm Design Techniques");
