...
Course Module 10: Binary Search Trees
...
generic BST, contains, findMin, findMax, insert, remove, printTree, height, counts, predecessor, successor, skewed tree, balanced order, invariant checker.

## Java Files in This Folder

- `PracticeModule10Demo.java`: main live-coding driver for the instructor.
...
1. Start with `PracticeModule10Demo.java` to frame the topic and vocabulary.
