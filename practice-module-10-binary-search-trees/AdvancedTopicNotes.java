...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "generic BST, contains, findMin, findMax, insert, remove, printTree, height, counts, predecessor, successor, skewed tree, balanced order, invariant checker";
}
