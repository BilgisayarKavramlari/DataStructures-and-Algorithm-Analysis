...
Course Module 5: Recursion, Factorial, and Fibonacci
...
base case, progress rule, design rule, call stack, recursive print, factorial, Fibonacci, memoization, duplicate work, safe stack limit.

## Java Files in This Folder

- `PracticeModule05Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule05Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule05Demo.java` to frame the topic and vocabulary.
