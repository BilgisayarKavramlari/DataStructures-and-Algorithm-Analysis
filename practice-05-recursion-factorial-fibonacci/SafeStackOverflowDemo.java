...
public class SafeStackOverflowDemo {
    public static void run() {
        System.out.println("-- SafeStackOverflowDemo: base case, progress rule, call stack, factorial, Fibonacci, memoization, duplicate work, safe stack limit");
        int[] data = {7, 3, 9, 1, 5};
