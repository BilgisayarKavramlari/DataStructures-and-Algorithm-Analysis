...
public class PriorityQueueIntroDemo {
    public static void run() {
        System.out.println("-- PriorityQueueIntroDemo: Collection, Iterable, Iterator, List, Set, Map, Queue, Deque, PriorityQueue, Collections, Arrays");
        int[] data = {7, 3, 9, 1, 5};
