...
public class ListArrayListLinkedListDemo {
    public static void run() {
        System.out.println("-- ListArrayListLinkedListDemo: Collection, Iterable, Iterator, List, Set, Map, Queue, Deque, PriorityQueue, Collections, Arrays");
        int[] data = {7, 3, 9, 1, 5};
