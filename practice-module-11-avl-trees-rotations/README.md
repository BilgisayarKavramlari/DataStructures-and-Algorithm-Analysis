...
Course Module 11: AVL Trees and Rotations
...
AVL insertion and educational deletion trace, height, balance factor, LL, RR, LR, RL rotations, invariant checker, BST comparison.

## Java Files in This Folder

- `PracticeModule11Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule11Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule11Demo.java` to frame the topic and vocabulary.
