...
Course Module 21: BFS, DFS, Connected Components, and Topological Sort
...
BFS, recursive DFS, iterative DFS, connected components, cycle detection, topological sort by indegree scanning and queue, DAG validation, traversal trace.

## Java Files in This Folder

- `PracticeModule21Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule21Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule21Demo.java` to frame the topic and vocabulary.
