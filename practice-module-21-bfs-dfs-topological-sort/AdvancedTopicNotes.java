...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "BFS, recursive DFS, iterative DFS, connected components, cycle detection, topological sort by indegree scanning and queue, DAG validation, traversal trace";
}
