...
O(1), O(log n), O(n), O(n log n), O(n^2), O(n^3), exponential, factorial growth, empirical timing, operation counting, dominant terms.

## Java Files in This Folder

- `PracticeModule04Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule04Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule04Demo.java` to frame the topic and vocabulary.
