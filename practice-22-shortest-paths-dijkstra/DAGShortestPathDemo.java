...
public class DAGShortestPathDemo {
    public static void run() {
        System.out.println("-- DAGShortestPathDemo: BFS shortest path, weighted graph, relaxation, Dijkstra variants, path reconstruction, negative edge limitation, DAG shortest path, all-pairs demo");
        int[] data = {7, 3, 9, 1, 5};
