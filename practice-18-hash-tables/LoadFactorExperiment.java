...
public class LoadFactorExperiment {
    public static void run() {
        System.out.println("-- LoadFactorExperiment: hash functions, chaining, probing, double hashing, lazy deletion, load factor, rehashing, Java maps/sets, cuckoo, hopscotch, universal, perfect, extendible hashing");
        int[] data = {7, 3, 9, 1, 5};
