...
/** Educational demo for Shortest Paths and Dijkstra Algorithm. */
public class NegativeWeightCounterexample {
    public static void main(String[] args) {
        int[] data = {5, 2, 8, 1, 3};
        System.out.println("NegativeWeightCounterexample: Shortest Paths and Dijkstra Algorithm");
