...
public class HeapSort {
    public static void run() {
        System.out.println("-- HeapSort: insertion sort, inversions, shellsort, heapsort, mergesort, quicksort, median-of-three, quickselect, radix/bucket, stability, timing, lower bound");
        int[] data = {7, 3, 9, 1, 5};
