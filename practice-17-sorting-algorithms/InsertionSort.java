...
public class InsertionSort {
    public static void run() {
        System.out.println("-- InsertionSort: insertion sort, inversions, shellsort, heapsort, mergesort, quicksort, median-of-three, quickselect, radix/bucket, stability, timing, lower bound");
        int[] data = {7, 3, 9, 1, 5};
