...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "basic disjoint sets, quick-find, quick-union, union by size, union by rank, path compression, path halving, equivalence class display, complexity experiment, maze generation";
}
