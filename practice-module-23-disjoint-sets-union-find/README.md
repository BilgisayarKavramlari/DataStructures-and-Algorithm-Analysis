...
Course Module 23: Disjoint Sets and Union-Find

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 8.

## Theory Topics Covered

basic disjoint sets, quick-find, quick-union, union by size, union by rank, path compression, path halving, equivalence class display, complexity experiment, maze generation.

## Java Files in This Folder

- `PracticeModule23Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule23Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule23Demo.java` to frame the topic and vocabulary.
