...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "TreeSet, TreeMap, SortedSet, NavigableSet, NavigableMap, Comparable, Comparator, equals vs compareTo, custom objects, range queries, floor, ceiling, lower, higher";
}
