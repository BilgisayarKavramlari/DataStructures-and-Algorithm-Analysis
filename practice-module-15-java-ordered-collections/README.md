...
Course Module 15: Java Ordered Collections

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic Java Collections.

## Theory Topics Covered

TreeSet, TreeMap, SortedSet, NavigableSet, NavigableMap, Comparable, Comparator, equals vs compareTo, custom objects, range queries, floor, ceiling, lower, higher.

## Java Files in This Folder

- `PracticeModule15Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule15Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule15Demo.java` to frame the topic and vocabulary.
