...
search/access splaying, insert, zig, zig-zig, zig-zag, trace output, access locality, amortized intuition.

## Java Files in This Folder

- `PracticeModule12Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule12Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule12Demo.java` to frame the topic and vocabulary.
