...
Course Module 7: Formal Algorithm Analysis

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 2.

## Theory Topics Covered

Big-O, Big-Omega, Big-Theta, little-o, little-omega, limit intuition, loop counting, if/else, binary search, recurrences, space complexity.

## Java Files in This Folder

- `PracticeModule07Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule07Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule07Demo.java` to frame the topic and vocabulary.
