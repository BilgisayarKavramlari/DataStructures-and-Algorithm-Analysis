...
Course Module 16: Binary Heap and Priority Queue

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 6.

## Theory Topics Covered

binary min heap, array representation, structure property, heap-order property, insert, deleteMin, findMin, percolate up/down, buildHeap, decreaseKey, increaseKey, delete position, kth selection, event simulation, d-heaps, leftist heaps, skew heaps, binomial queues.

## Java Files in This Folder

- `PracticeModule16Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule16Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule16Demo.java` to frame the topic and vocabulary.
