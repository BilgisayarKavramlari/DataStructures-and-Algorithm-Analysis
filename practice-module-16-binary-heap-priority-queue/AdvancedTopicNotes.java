...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "binary min heap, array representation, structure property, heap-order property, insert, deleteMin, findMin, percolate up/down, buildHeap, decreaseKey, increaseKey, delete position, kth selection, event simulation, d-heaps, leftist heaps, skew heaps, binomial queues";
}
