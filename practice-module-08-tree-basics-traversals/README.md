...
Course Module 8: Tree Basics and Traversals
...
tree terminology, first-child/next-sibling, binary tree node, preorder, inorder, postorder, level order, directory listing, postorder size.

## Java Files in This Folder

- `PracticeModule08Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule08Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule08Demo.java` to frame the topic and vocabulary.
