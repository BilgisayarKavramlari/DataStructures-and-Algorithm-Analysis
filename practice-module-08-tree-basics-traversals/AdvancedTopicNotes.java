...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "tree terminology, first-child/next-sibling, binary tree node, preorder, inorder, postorder, level order, directory listing, postorder size";
}
