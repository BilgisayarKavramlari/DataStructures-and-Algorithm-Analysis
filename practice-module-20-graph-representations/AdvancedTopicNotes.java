...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "directed, undirected, weighted, unweighted, adjacency matrix, adjacency list, edge list, degree, indegree, outdegree, sparse/dense, memory/time tradeoffs";
}
