...
Course Module 20: Graph Representations
...
directed, undirected, weighted, unweighted, adjacency matrix, adjacency list, edge list, degree, indegree, outdegree, sparse/dense, memory/time tradeoffs.

## Java Files in This Folder

- `PracticeModule20Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule20Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule20Demo.java` to frame the topic and vocabulary.
