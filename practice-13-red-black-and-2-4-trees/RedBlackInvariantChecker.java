...
public class RedBlackInvariantChecker {
    public static void run() {
        System.out.println("-- RedBlackInvariantChecker: red-black invariants, insertion, recoloring, rotations, double-red repair, 2-4 correspondence, deletion concepts");
        int[] data = {7, 3, 9, 1, 5};
