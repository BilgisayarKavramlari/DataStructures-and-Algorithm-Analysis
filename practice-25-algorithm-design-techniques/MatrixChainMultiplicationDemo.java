...
public class MatrixChainMultiplicationDemo {
    public static void run() {
        System.out.println("-- MatrixChainMultiplicationDemo: greedy scheduling, Huffman, bin packing, divide and conquer, selection, dynamic programming, matrix chain, optimal BST, randomized quicksort, skip list, primality, backtracking");
        int[] data = {7, 3, 9, 1, 5};
