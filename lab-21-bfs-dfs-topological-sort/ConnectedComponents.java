...
/** Educational demo for BFS, DFS, Connected Components, and Topological Sort. */
public class ConnectedComponents {
    public static void main(String[] args) {
        int[] data = {5, 2, 8, 1, 3};
        System.out.println("ConnectedComponents: BFS, DFS, Connected Components, and Topological Sort");
