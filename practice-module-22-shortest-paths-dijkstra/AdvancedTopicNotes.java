...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "unweighted BFS shortest path, weighted graph, Dijkstra without priority queue, Dijkstra with PriorityQueue, relaxation, path reconstruction, negative-edge counterexample, DAG shortest path, all-pairs demonstration";
}
