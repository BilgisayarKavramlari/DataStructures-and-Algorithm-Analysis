...
Course Module 22: Shortest Paths and Dijkstra

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 9.

## Theory Topics Covered

unweighted BFS shortest path, weighted graph, Dijkstra without priority queue, Dijkstra with PriorityQueue, relaxation, path reconstruction, negative-edge counterexample, DAG shortest path, all-pairs demonstration.

## Java Files in This Folder

- `PracticeModule22Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule22Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule22Demo.java` to frame the topic and vocabulary.
