...
public class NavigableMapDemo {
    public static void run() {
        System.out.println("-- NavigableMapDemo: Comparable, Comparator, TreeSet, TreeMap, SortedSet, NavigableSet, NavigableMap, range queries, equals/compareTo consistency");
        int[] data = {7, 3, 9, 1, 5};
