...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "red-black insertion, recoloring, rotations, root black, red-parent rule, black height, invariant checker, trace, 2-4 correspondence, double-red remedy, deletion double-black concepts";
}
