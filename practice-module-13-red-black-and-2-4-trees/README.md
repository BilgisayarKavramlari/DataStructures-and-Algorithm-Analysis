...
Course Module 13: Red-Black Trees and 2-4 Trees
...
red-black insertion, recoloring, rotations, root black, red-parent rule, black height, invariant checker, trace, 2-4 correspondence, double-red remedy, deletion double-black concepts.

## Java Files in This Folder

- `PracticeModule13Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule13Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule13Demo.java` to frame the topic and vocabulary.
