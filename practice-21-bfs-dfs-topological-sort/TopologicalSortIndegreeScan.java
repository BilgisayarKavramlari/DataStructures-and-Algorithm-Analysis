...
public class TopologicalSortIndegreeScan {
    public static void run() {
        System.out.println("-- TopologicalSortIndegreeScan: BFS, DFS recursive/iterative, visited set, connected components, cycle detection, topological sort, DAG validation");
        int[] data = {7, 3, 9, 1, 5};
