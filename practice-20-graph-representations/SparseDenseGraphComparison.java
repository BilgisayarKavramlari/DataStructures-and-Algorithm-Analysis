...
public class SparseDenseGraphComparison {
    public static void run() {
        System.out.println("-- SparseDenseGraphComparison: vertices, edges, paths, cycles, directed/undirected, weighted/unweighted, adjacency list/matrix, edge list, degree, sparse/dense");
        int[] data = {7, 3, 9, 1, 5};
