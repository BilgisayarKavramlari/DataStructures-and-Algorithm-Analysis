...
public class BTreeSplitDemo {
    public static void run() {
        System.out.println("-- BTreeSplitDemo: multi-way search, B-tree degree, search path, insertion, split, median promotion, root/internal split, disk-block motivation, deletion concepts");
        int[] data = {7, 3, 9, 1, 5};
