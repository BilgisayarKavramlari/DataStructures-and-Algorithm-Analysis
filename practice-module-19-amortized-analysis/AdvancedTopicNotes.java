...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "dynamic array resizing, table doubling, aggregate analysis, accounting, potential, append, rehashing, splay amortized intuition, binomial queue merge, skew heap, Fibonacci heap concept";
}
