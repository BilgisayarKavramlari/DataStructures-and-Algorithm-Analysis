...
Course Module 19: Amortized Analysis

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 11.

## Theory Topics Covered

dynamic array resizing, table doubling, aggregate analysis, accounting, potential, append, rehashing, splay amortized intuition, binomial queue merge, skew heap, Fibonacci heap concept.

## Java Files in This Folder

- `PracticeModule19Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule19Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule19Demo.java` to frame the topic and vocabulary.
