...
public class DynamicArrayResizeTraceDemo {
    public static void run() {
        System.out.println("-- DynamicArrayResizeTraceDemo: dynamic array resizing, table doubling, aggregate/accounting/potential, rehashing, splay, binomial queue, skew heap, Fibonacci heap concepts");
        int[] data = {7, 3, 9, 1, 5};
