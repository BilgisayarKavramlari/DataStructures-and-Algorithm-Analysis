...
public class MaxSubsequenceTimingComparison {
    public static void run() {
        System.out.println("-- MaxSubsequenceTimingComparison: cubic, quadratic, divide-and-conquer, linear Kadane, trace, timing, all-negative input");
        int[] data = {7, 3, 9, 1, 5};
