...
public class ArraysAndReferencesDemo {
    public static void run() {
        System.out.println("-- ArraysAndReferencesDemo: primitive/reference types, arrays, loops, methods, objects, generics, Comparable, Comparator, timing");
        int[] data = {7, 3, 9, 1, 5};
