...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "cumulative mixed examples, selection cases, complexity classification, tracing, algorithm comparison, graph/path/MST, hashing/tree/heap, sorting, final-style prompts";
}
