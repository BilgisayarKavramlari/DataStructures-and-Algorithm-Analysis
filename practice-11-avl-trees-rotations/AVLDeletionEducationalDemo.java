...
public class AVLDeletionEducationalDemo {
    public static void run() {
        System.out.println("-- AVLDeletionEducationalDemo: AVL invariant, balance factor, LL/RR/LR/RL rotations, insertion, deletion concept, invariant checker, BST comparison");
        int[] data = {7, 3, 9, 1, 5};
