...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "integer hash, string hash, polynomial hash, separate chaining, linear probing, quadratic probing, double hashing, lazy deletion, load factor, rehashing, HashMap, HashSet, cuckoo, hopscotch, universal, perfect, extendible hashing";
}
