...
Course Module 18: Hash Tables

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 5.

## Theory Topics Covered

integer hash, string hash, polynomial hash, separate chaining, linear probing, quadratic probing, double hashing, lazy deletion, load factor, rehashing, HashMap, HashSet, cuckoo, hopscotch, universal, perfect, extendible hashing.

## Java Files in This Folder

- `PracticeModule18Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule18Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule18Demo.java` to frame the topic and vocabulary.
