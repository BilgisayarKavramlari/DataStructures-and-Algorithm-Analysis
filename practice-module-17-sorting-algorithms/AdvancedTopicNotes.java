...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "insertion sort, shellsort, heapsort, mergesort, quicksort, median-of-three, quickselect, bucket/radix intro, stability, inversion counting, lower bound, timing, traces";
}
