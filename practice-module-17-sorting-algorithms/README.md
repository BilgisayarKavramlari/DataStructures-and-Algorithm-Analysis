...
Course Module 17: Sorting Algorithms

## Related Weiss Chapter and Section Topic

Mark Allen Weiss, *Data Structures and Algorithm Analysis in Java*, 3rd edition: Chapter/section topic 7.

## Theory Topics Covered

insertion sort, shellsort, heapsort, mergesort, quicksort, median-of-three, quickselect, bucket/radix intro, stability, inversion counting, lower bound, timing, traces.

## Java Files in This Folder

- `PracticeModule17Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule17Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule17Demo.java` to frame the topic and vocabulary.
