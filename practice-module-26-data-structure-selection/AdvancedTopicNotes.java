...
public class AdvancedTopicNotes {
    ...
    static final String TOPICS = "ArrayList, LinkedList, stack, queue, deque, hash table, tree, heap, graph, union-find, trie, suffix-array-style string index, k-d tree, treap, pairing heap, real-world scenarios";
}
