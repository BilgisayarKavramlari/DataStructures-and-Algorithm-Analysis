...
public class ListADTTraceDemo {
    public static void run() {
        System.out.println("-- ListADTTraceDemo: ADT operations, array list, linked list, doubly linked list, stack, queue, deque, iterator, ConcurrentModificationException");
        int[] data = {7, 3, 9, 1, 5};
