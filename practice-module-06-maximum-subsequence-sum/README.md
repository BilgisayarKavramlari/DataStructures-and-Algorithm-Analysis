...
Course Module 6: Maximum Subsequence Sum
...
cubic, quadratic, divide and conquer, linear Kadane, timing comparison, trace output.

## Java Files in This Folder

- `PracticeModule06Demo.java`: main live-coding driver for the instructor.
...
```bash
java PracticeModule06Demo
java TraceDemo
```

## Instructor Teaching Flow

1. Start with `PracticeModule06Demo.java` to frame the topic and vocabulary.
