...
public class PostorderSizeCalculationDemo {
    public static void run() {
        System.out.println("-- PostorderSizeCalculationDemo: tree terminology, first-child/next-sibling, binary tree, preorder, inorder, postorder, level-order, directory tree, postorder size");
        int[] data = {7, 3, 9, 1, 5};
