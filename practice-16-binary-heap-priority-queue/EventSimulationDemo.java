...
public class EventSimulationDemo {
    public static void run() {
        System.out.println("-- EventSimulationDemo: binary heap, heap-order, array representation, insert, deleteMin, buildHeap, key changes, selection, simulation, d-heaps, leftist, skew, binomial queues");
        int[] data = {7, 3, 9, 1, 5};
